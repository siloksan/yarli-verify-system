...
export function ScannerInProgress({ hideModal }: Props) {
  return (
...
interface ScannerInProgressProps extends Props {
...
export function ScannedError({ hideModal, message }: ScannedErrorProps) {
  return (
    <View style={styles.modalContent}>
